...
class ProjectStatisticsSerializer(serializers.Serializer):
    ...
    total_scripts = serializers.IntegerField(required=False, default=0)
    total_knowledge_bases = serializers.IntegerField(required=False, default=0)
    total_documents = serializers.IntegerField(required=False, default=0)
